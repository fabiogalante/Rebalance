...
namespace JSONUtils
{
    ...
    public class Prefixado
    {
        public string CDI { get; set; }
        public string IBOVESPA { get; set; }
    }

    public class PosFixadoLiquidezDiaria
    {
        public string CDI { get; set; }
        public string IBOVESPA { get; set; }
    }
    ...
    {
        public IPCA IPCA { get; set; }
        public Prefixado Prefixado { get; set; }
        public PósFixadoLiquidezDiária Pós-fixado Liquidez Diária {
            get;
            set;
        }
    }
    ...
    {
        public TítuloDeRendaFixa Título de Renda Fixa {
            get;
            set;
        }
    }
